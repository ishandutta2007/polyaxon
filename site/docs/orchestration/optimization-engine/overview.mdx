 ...
 * [Hyperopt](/docs/references/polyaxonfile/automation/matrix/bayesian-optimization/)
 * [Custom iterative Optimization](/docs/references/polyaxonfile/automation/matrix/iterative/)
...
You can check all the options available in the [params section reference](/docs/references/polyaxonfile/automation/matrix/params/).
