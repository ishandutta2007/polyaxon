...
- __Args__:
  ...
  - __scheduling_policy__: [V1SchedulingPolicy](/docs/references/polyaxonfile/runtimes/distributed/kubeflow-scheduling-policy/), optional
  - __enable_dynamic_worker__: boolean
  - __chief__: [V1KFReplica](/docs/references/polyaxonfile/runtimes/distributed/kubeflow-replica/), optional
  - __ps__: [V1KFReplica](/docs/references/polyaxonfile/runtimes/distributed/kubeflow-replica/), optional
  - __worker__: [V1KFReplica](/docs/references/polyaxonfile/runtimes/distributed/kubeflow-replica/), optional
  - __evaluator__: [V1KFReplica](/docs/references/polyaxonfile/runtimes/distributed/kubeflow-replica/), optional
