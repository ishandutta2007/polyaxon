...
- __Args__:
  ...
  - __params__: List[Dict[str, [params](/docs/references/polyaxonfile/automation/matrix/params/#discrete-values)]]
  ...
  - __tuner__: [V1Tuner](/docs/references/polyaxonfile/automation/matrix/tuner/), optional
