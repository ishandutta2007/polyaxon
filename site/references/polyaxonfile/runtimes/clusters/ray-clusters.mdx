...
- __Args__:
  ...
  - __head__: [V1RayReplica](/docs/references/polyaxonfile/runtimes/clusters/ray-replica/), optional
  - __workers__: Dict[str, [V1RayReplica](/docs/references/polyaxonfile/runtimes/clusters/ray-replica/)], optional
  - __enable_in_tree_autoscaling__: bool, optional
  - __autoscaler_options__: [V1RayAutoscalerOptions](/docs/references/polyaxonfile/runtimes/clusters/ray-clusters/), optional
