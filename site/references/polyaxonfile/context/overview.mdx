...
After finishing the params section, the next section is the params defined in [joins](/docs/references/polyaxonfile/automation/joins/).
...
([Optimization](/docs/references/polyaxonfile/automation/matrix/overview/) or [Mapping](/docs/references/polyaxonfile/automation/mapping/)).
