...
Please refer to [jobs](/docs/compute/jobs/overview/) for more details.
</blockquote>
...
<blockquote className="light">
Please refer to [distributed jobs](/docs/distributed-compute/distributed-jobs/overview/) for more details.
</blockquote>
...
<blockquote className="light">
Please refer to [services](/docs/compute/services/overview/) for more details.
</blockquote>
