...
> For more details check the [grid search reference](/docs/references/polyaxonfile/automation/matrix/grid-search/)
...
> For more details check the [random search reference](/docs/references/polyaxonfile/automation/matrix/random-search/)
...
Polyaxon provides several generators for defining a [search space](/docs/references/polyaxonfile/automation/matrix/params/) and several
