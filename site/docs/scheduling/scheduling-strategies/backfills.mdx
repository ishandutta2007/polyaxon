...
Polyaxon provides a [daterange](/docs/references/polyaxonfile/automation/matrix/params/#v1hpdaterange) and a [datetimerange](/docs/references/polyaxonfile/automation/matrix/params/#v1hpdatetimerange)
