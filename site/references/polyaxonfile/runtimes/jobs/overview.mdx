...
Please check the [job specification](/docs/references/polyaxonfile/runtimes/jobs/specification/) guide to learn about all details for running jobs in Polyaxon.
