 ...
 * They can run and orchestrate [jobs](/docs/compute/jobs/), [distributed jobs](/docs/distributed-compute/distributed-jobs/), and [services](/docs/compute/services/).
...
Please check the [DAG specification](/docs/references/polyaxonfile/automation/dag/) guide to learn about all details for DAGs in Polyaxon.
