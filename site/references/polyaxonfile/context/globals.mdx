...
When an operation is automatically created by a [schedule](/docs/references/polyaxonfile/automation/schedules/overview/), the globals prefix will include additionally these information:
